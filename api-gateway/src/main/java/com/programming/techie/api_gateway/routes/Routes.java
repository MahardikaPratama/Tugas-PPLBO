...
public class Routes{
    ...
    @Bean
    public RouterFunction<ServerResponse> productServiceSwagggerRoute(){
    ...
    @Bean
    public RouterFunction<ServerResponse> orderServiceSwagggerRoute(){
    ...
    @Bean
    public RouterFunction<ServerResponse> inventoryServiceSwagggerRoute(){
